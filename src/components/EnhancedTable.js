...
const rows = [
  createData('Payroll2016.pdf', '24 Nov, 22', 'Financial', 'Complete'),
...
const TagsProps = [
  { id: 1, title: 'Financial', val: 4 },
  { id: 2, title: 'Technical', val: 0 },
  { id: 3, title: 'NOA', val: 1 },
  { id: 4, title: 'Accounting', val: 0 },
...
export default function EnhancedTable() {
  ...
  const [curTabIndex, setCurTabIndex] = React.useState(1);
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        ...
        <div className='tag-container'>
          {TagsProps.map((tag, index) => (
            <Tag
              key={index}
              item={tag}
              onChange={(value) => setCurTabIndex(value)}
